...
var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
          ...
          // Calculate the budget: income - expensess
...
var UIController = (function() {
    ...
    return {
        getInput: function() {
            ...
            return {
                type : document.querySelector(DOMstrings.inputType).value, // Will be other inc or exp
        ...
        displayMonth: function() {
            ...
            var now = new Date();
            //var christmas = new Date(2020, 12, 31);
